...
<img-crop
   ...
   [min-canvas-dimensions="{ number|{w:number,h:number} }"]
...
### min-canvas-dimensions

*Optional*. Min. width/height of the canvas area (in pixels) to start with, overriding the default minimum. Default: 100x100
